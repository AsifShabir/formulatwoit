...
class Psi29SyncOrder extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'pos:Psi29SyncOrder';
     ...
     * @var string
     */
    protected $description = 'Syncs all orders from Psi29SyncOrder to POS';
    ...
    public function handle()
    {
        try {
            ...
            $store = WoocommerceStoreCredential::where('app_url', 'https://29psi.com/')->first();
        ...
        $this->info('29Psi orders sync successfully');
    }

...
class TuboPlusSyncOrder extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'pos:TuboPlusSyncOrder';
     ...
     * @var string
     */
    protected $description = 'Syncs all orders from TuboPlusSyncOrder to POS';
    ...
    public function handle()
    {
        try {
            ...
            $store = WoocommerceStoreCredential::where('app_url', 'https://tubo.plus/')->first();
        ...
        $this->info('TuboPlus orders sync successfully');
    }

...
class Product extends Model
{
    ...
    {
        return $this->belongsToMany(Component::class)->using(ComponentProduct::class);
    }

    public function product_components()
    {
        return $this->belongsToMany(\App\ComponentProduct::class, 'component_product', 'product_id', 'component_id');
    }

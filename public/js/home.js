$(document).ready(function() {
    if ($('#dashboard_date_filter').length == 1) {
        ...
        dateRangeSettings.startDate = moment().subtract(1, 'weeks');
        dateRangeSettings.endDate = moment();
        //console.log({ dateRangeSettings }, moment().subtract(29, 'days'));
    ...
    if ($('#countries_date_filter').length == 1) {
        dateRangeSettings.startDate = moment();
        dateRangeSettings.endDate = moment();
        $('#countries_date_filter').daterangepicker(dateRangeSettings, function (start, end) {
            $('#countries_date_filter span').html(
                start.format(moment_date_format) + ' ~ ' + end.format(moment_date_format)
            );

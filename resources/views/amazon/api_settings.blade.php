...
<section class="content">
    {!! Form::open(['action' => '\App\Http\Controllers\Amazon\AmazonController@updateSettings', 'method' => 'post']) !!}
    <div class="row">
        <div class="col-xs-12">
           <!--  <pos-tab-container> -->
            <div class="col-xs-12 pos-tab-container">
                ...
                <div class="col-lg-10 col-md-10 col-sm-10 col-xs-10 pos-tab">
                    @include('amazon.partials.api_instructions')
                    @include('amazon.partials.api_settings')
                    @include('amazon.partials.product_sync_settings')
                    @include('amazon.partials.order_sync_settings')
                    @include('amazon.partials.webhook_settings')
                </div>
            </div>

<div class="pos-tab-content active">
    <div class="row">
        ...
        <div class="col-sm-4">
            <div class="form-group">
                {!! Form::label('stock_reminder_email', __('lang_v1.stock_reminder_email') . ':*') !!} 
                {!! Form::email('stock_reminder_email', $business->stock_reminder_email ?? 'pedidosinyeccion@mypainyeccion.com', ['class' => 'form-control', 'required']) !!}
            </div>
        </div>
    </div>
     {{-- code --}}

...
<section class="content">
    {!! Form::open(['action' => '\App\Http\Controllers\Decathlon\DecathlonController@updateSettings', 'method' => 'post']) !!}
    <div class="row">
        <div class="col-xs-12">
           <!--  <pos-tab-container> -->
            <div class="col-xs-12 pos-tab-container">
                ...
                <div class="col-lg-10 col-md-10 col-sm-10 col-xs-10 pos-tab">
                    @include('decathlon.partials.api_instructions')
                    @include('decathlon.partials.api_settings')
                    @include('decathlon.partials.product_sync_settings')
                    @include('decathlon.partials.order_sync_settings')
                    @include('decathlon.partials.webhook_settings')
                </div>
            </div>

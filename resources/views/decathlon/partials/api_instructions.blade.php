    ...
    <div class="row">
    	<div class="col-sm-12">
    		<ul>
    			...
    			<li>Timezone of POS should be same as timezone of the Amazon App</li>
    			<li>Get Amazon API details from, Amazon -> Settings -> Advance -> REST API . Enter description, select User & Provide Read/Write Permission. Click here for more info</li>

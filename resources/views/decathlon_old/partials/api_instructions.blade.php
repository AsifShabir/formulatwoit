    ...
    <div class="row">
    	<div class="col-sm-12">
    		<ul>
    			...
    			<li>Timezone of POS should be same as timezone of the Decathlon App</li>
    			<li>Get Decathlon API details from, Decathlon -> Settings -> Advance -> REST API . Enter description, select User & Provide Read/Write Permission. Click here for more info</li>

    ...
    <div class="row">
    	<div class="col-xs-4">
            <div class="form-group">
            	{!! Form::label('woocommerce_app_url',  __('App Key') . ':') !!}
            	{!! Form::text('woocommerce_app_url', $default_settings['woocommerce_app_url'], ['class' => 'form-control','placeholder' => __('App Key')]); !!}
            </div>
        </div>
        <div class="col-xs-4">
            <div class="form-group">
                {!! Form::label('woocommerce_consumer_key',  __('App Secret') . ':') !!}
                {!! Form::text('woocommerce_consumer_key', $default_settings['woocommerce_consumer_key'], ['class' => 'form-control','placeholder' => __('App Secret')]); !!}
            </div>
        </div>
        <div class="col-xs-4">
            <div class="form-group">
            	{!! Form::label('woocommerce_consumer_secret', __('App Access Token') . ':') !!}

    ...
    @if(auth()->user()->can('dashboard.data'))
        ...
        <div class="row">
            <div class="col-xs-12">
                @component('components.widget', ['class' => 'box-primary'])
                    ...
                    @endslot
                    {!! $trending_products_chart->container() !!}
                @endcomponent
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-xs-12">
                @component('components.widget', ['class' => 'box-primary'])
                    @slot('title')
                        @lang('report.top_trending_countries') @show_tooltip(__('tooltip.top_trending_countries'))
                    @endslot
                    <div class="form-group pull-right">
                          <div class="input-group">
                            <button type="button" class="btn btn-primary" id="countries_date_filter">
                              <span>
                                @if(isset($_GET['start']))
                                @php
                                    $start_date = date('m/d/Y', strtotime($_GET['start']));
                                    $end_date = date('m/d/Y', strtotime($_GET['end']));
                    ...
                    {!! $trending_country_chart->container() !!}
                @endcomponent
            </div>
        </div>
...
@section('javascript')
    ...
    {!! $trending_products_chart->script() !!}
    {!! $trending_country_chart->script() !!}

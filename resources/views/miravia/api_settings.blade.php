...
<section class="content">
    {!! Form::open(['action' => '\App\Http\Controllers\Miravia\MiraviaController@updateSettings', 'method' => 'post']) !!}
    <div class="row">
        <div class="col-xs-12">
           <!--  <pos-tab-container> -->
            <div class="col-xs-12 pos-tab-container">
                ...
                <div class="col-lg-10 col-md-10 col-sm-10 col-xs-10 pos-tab">
                    @include('miravia.partials.api_instructions')
                    @include('miravia.partials.api_settings')
                    @include('miravia.partials.product_sync_settings')
                    @include('miravia.partials.order_sync_settings')
                    @include('miravia.partials.webhook_settings')
                </div>
            </div>

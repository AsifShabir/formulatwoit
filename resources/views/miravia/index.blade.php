    ...
    <div class="row">
        ...
        <div class="col-sm-6">
            ...
            <!-- <div class="col-sm-12">
                <div class="box box-solid">
                    ...
                    <div class="box-body">
                        {!! Form::open(['action' => 'App\Http\Controllers\Miravia\MiraviaController@mapTaxRates', 'method' => 'post']) !!}
                        <div class="col-xs-12">
                            <table class="table">
                                <thead>
                                    <tr>
            ...
            <div class="col-sm-12">
                <div class="box box-solid">
                    ...
                    <div class="box-body">
                        ...
                        <div class="col-sm-6">
                            <button type="button" class="btn btn-warning btn-block sync_stocks"> <i class="fa fa-refresh"></i> @lang('woocommerce::lang.sync')</button>
        ...
        <div class="col-sm-6">
            <div class="box box-solid">
                ...
                <div class="box-body">
                    <div class="col-sm-6">
                        <button type="button" class="btn btn-success btn-block sync_orders"> <i class="fa fa-refresh"></i> @lang('woocommerce::lang.sync')</button>
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        $('.get_products').click(function() {
            ...
            $.ajax({
                url: "{{ action([App\Http\Controllers\Miravia\MiraviaController::class, 'getProducts']) }}",
                dataType: "json",
                timeout: 0,
        ...
        $('.sync_stocks').click(function() {
            ...
            $.ajax({
                url: "{{ action([App\Http\Controllers\Miravia\MiraviaController::class, 'syncStock']) }}",
                dataType: "json",
                timeout: 0,
                success: function(result) {
                    if (result.success) {
        ...
        $('.sync_orders').click(function() {
            ...
            $.ajax({
                url: "{{ action([App\Http\Controllers\Miravia\MiraviaController::class, 'syncOrders']) }}",
                dataType: "json",
                timeout: 0,
                success: function(result) {
                    if (result.success) {
    ...
    function update_sync_date() {
        $.ajax({
            url: "{{action([App\Http\Controllers\Miravia\MiraviaController::class, 'getSyncLog'])}}",
            dataType: "json",
            timeout: 0,
        ...
        swal({
            ...
            if (confirm) {
                if ($('#yes_reset_cat').is(":checked")) {
                    ...
                    btn.attr('disabled', true);
                    $.ajax({
                        url: "{{action([App\Http\Controllers\Miravia\MiraviaController::class, 'resetCategories'])}}",
                        dataType: "json",
                        success: function(result) {
        ...
        swal({
            ...
            if (confirm) {
                if ($('#yes_reset_product').is(":checked")) {
                    ...
                    btn.attr('disabled', true);
                    $.ajax({
                        url: "{{action([App\Http\Controllers\Miravia\MiraviaController::class, 'resetProducts'])}}",
                        dataType: "json",
                        success: function(result) {
                            if (result.success == true) {
                                toastr.success(result.msg);

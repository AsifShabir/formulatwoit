    ...
    <div class="row">
        ...
        <div class="col-sm-4">
            <div class="form-group">
                ...
                {!! Form::select('woocommerce_product_id', $woo_products, null, ['placeholder' => __('messages.please_select'), 'class' => 'form-control select2', 'id' => 'woocommerce_product_id']) !!}
            </div>
        </div>
        ...
        <div class="col-sm-4">
            <div class="form-group">
                ...
                {!! Form::select('miravia_product_id', $miravas, null, ['placeholder' => __('messages.please_select'), 'class' => 'form-control select2', 'id' => 'miravia_product_id']) !!}
            </div>
        </div>
        ...
        <div class="col-sm-4">
            <div class="form-group">
                ...
                {!! Form::select('amazon_product_id', $amazon_products, '', ['placeholder' => __('messages.please_select'), 'class' => 'form-control select2']) !!}
            </div>
        </div>
        ...
        <div class="col-sm-4">
            <div class="form-group">
                ...
                {!! Form::select('decathlon_product_id', $decathlon_products, '', ['placeholder' => __('messages.please_select'), 'class' => 'form-control select2']) !!}
            </div>
        </div>
        ...
        <div class="col-sm-4 @if(!empty($duplicate_product) && $duplicate_product->enable_stock == 0) hide @endif" id="alert_quantity_mypa_div">
            <div class="form-group">
                {!! Form::label('alert_quantity_mypa', __('product.alert_quantity') . ' (MYPA):') !!} @show_tooltip(__('tooltip.alert_quantity'))
                {!! Form::text('alert_quantity_mypa', !empty($duplicate_product->alert_quantity_mypa) ? @format_quantity($duplicate_product->alert_quantity_mypa) : null , ['class' => 'form-control input_number',
                'placeholder' => __('product.alert_quantity'), 'min' => '0']); !!}
            </div>
        </div>
        <div class="col-sm-4 @if(!empty($duplicate_product) && $duplicate_product->enable_stock == 0) hide @endif" id="alert_quantity_div">
            <div class="form-group">
                ...
                {!! Form::text('alert_quantity_amazon', !empty($duplicate_product->alert_quantity_amazon) ? @format_quantity($duplicate_product->alert_quantity_amazon) : null , ['class' => 'form-control input_number',
                'placeholder' => __('product.alert_quantity_amazon'), 'min' => '0']); !!}
            </div>
        </div>
        <div class="col-sm-4">
            <div class="form-group">
                {!! Form::label('product_components', __('component.components') . ':') !!} @show_tooltip(__('component.components_help'))
                {!! Form::select('product_components[]', $product_components, $default_location, ['class' => 'form-control select2', 'multiple', 'id' => 'product_components']); !!}
            </div>
        </div>

    ...
    <td>
        <table class="table table-condensed table-bordered blue-header variation_value_table">
            ...
            <tr>
                ...
                <td>
                    {!! Form::select('product_variation[' .$row_index. '][variations][0][woocommerce_variation_id]', $woo_variations, null, ['placeholder' => __('messages.please_select'), 'class' => 'form-control select2']); !!}
                </td>
                <td>
                    {!! Form::select('product_variation[' .$row_index. '][variations][0][miravia_variation_id]', $miravia_variations, null, ['placeholder' => __('messages.please_select'), 'class' => 'form-control select2']); !!}
                </td>
                <td>
                    {!! Form::select('product_variation[' .$row_index. '][variations][0][amazon_variation_id]', $amazon_variations, null, ['placeholder' => __('messages.please_select'), 'class' => 'form-control select2']); !!}
                </td>
                <td class="{{$class}}">

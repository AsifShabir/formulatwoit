...
<tr @if(!empty($variation_value_id)) 
    ...
    <td>
        {!! Form::select('product_variation[' .$variation_index. '][variations][' . $value_index . '][woocommerce_variation_id]', $woo_variations, null, ['placeholder' => __('messages.please_select'), 'class' => 'form-control select2']); !!}
    </td>
    <td>
        {!! Form::select('product_variation[' .$variation_index. '][variations][' . $value_index . '][miravia_variation_id]', $miravia_variations, null, ['placeholder' => __('messages.please_select'), 'class' => 'form-control select2']); !!}
    </td>
    <td></td>
    <td class="{{$class}}">

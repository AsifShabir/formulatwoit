@extends('layouts.app')
@section('title', __( 'lang_v1.delivery_note'))
@section('content')

<!-- Content Header (Page header) -->
<section class="content-header no-print">
    <h1>@lang('lang_v1.delivery_note')
    </h1>
</section>
    ...
    @component('components.widget', ['class' => 'box-primary'])
        @slot('tool')
            <div class="box-tools">
                ...
                <i class="fa fa-plus"></i> @lang('Add Delivery Note')</a>
            </div>
        @endslot
...
$(document).ready( function(){
    ...
    sell_table = $('#sell_table').DataTable({
        ...
        aaSorting: [[0, 'desc']],
        "ajax": {
            "url": '/sells/draft-dt?is_quotation=0&is_delivery_note=1',
            "data": function ( d ) {

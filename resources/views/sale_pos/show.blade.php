<div class="modal-dialog modal-xl no-print" role="document">
  <div class="modal-content">
    ...
    <h4 class="modal-title" id="modalTitle"> @lang('sale.sell_details') 
      ...
      @elseif($sell->source == 'Miravia' || $sell->source == 'Decathlon') 
        @lang('lang_v1.delivery_note') :</b> {{ $sell->delivery_note_number }}
      @else 
...
<div class="modal-body">
  ...
  <div class="modal-footer">
    @if($sell->type != 'sales_order')
    <a class="btn btn-info" href="{{route('sell.printInvoice', [$sell->id])}}?package_slip=true&shipping=fedex" target="_blank"><i class="fas fa-file-alt" aria-hidden="true"></i> Generate shipping Label</a>

    {{-- <a class="btn btn-success" href="{{route('sell.printInvoice', [$sell->id])}}?package_slip=true"><i class="fas fa-file-alt" aria-hidden="true"></i> @lang("lang_v1.packing_slip")</a> --}}
    ...
    @endif
    @can('print_invoice')
      @if(in_array($sell->source, ['Miravia', 'Decathlon']))

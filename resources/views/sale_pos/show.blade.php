...
<div class="modal-body">
  ...
  <div class="modal-footer">
    @if($sell->type != 'sales_order')
    <a class="btn btn-info" href="{{route('sell.printInvoice', [$sell->id])}}?package_slip=true&shipping=fedex"><i class="fas fa-file-alt" aria-hidden="true"></i> Generate shipping Label</a>

...
<section class="content-header no-print">
    <h1>@lang( 'Documents')
        ...
        <button class="btn btn-primary" data-toggle="modal" data-target="#generateLabelsByDate" style="float: right;">Generate Shipping Labels</button>

        <button class="btn btn-primary" data-toggle="modal" data-target="#generateinvoices" style="float: right;margin-right:20px;">Generate Bulk Invoices</button>

        <button class="btn btn-primary" data-toggle="modal" data-target="#generatedelivery_note" style="float: right;margin-right:20px;">Generate Bulk Delivery Notes</button>
...
<!-- Modal -->
<div class="modal fade" id="generateLabelsByDate" tabindex="-1" role="dialog" aria-labelledby="generateLabelsByDateLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="generateLabelsByDateLabel">Generate Labels By Date</h5>
      ...
      <div class="modal-body">
        <div class="form-group">
            <input type="text" id="generateLabelDatePicker" class="form-control" name="date" value="<?php echo date("Y-m-d") ?>" />
        </div>
      </div>
      <div class="modal-footer">
        ...
        <button type="button" id="runCommandBtn" class="btn btn-primary">Generate Fedex Shipping Labels</button>
        <button type="button" id="runCommandBtnGLS" class="btn btn-primary">Generate GLS Shipping Labels</button>
      </div>
    </div>
  </div>
</div>

<div class="modal fade" id="generateinvoices" tabindex="-1" role="dialog" aria-labelledby="generateinvoicesLabel" aria-hidden="true">
  <div class="modal-dialog modal-dialog-lg" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="generateinvoicesLabel">Generate Invoices By:</h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>

...
<div class="col-md-3">
    <div class="form-group">
        ...
        {!! Form::select('sell_list_filter_location_id', $business_locations, null, ['class' => 'form-control select2', 'style' => 'width:100%', 'placeholder' => __('lang_v1.all'), 'disabled'=>true ]); !!}
    </div>
</div>
@endif
...
@endif
    ...
    {{-- <div class="col-md-3">
        <div class="form-group">
            {!! Form::label('sell_list_filter_source', __('Source') . ':') !!}
            {!! Form::select('sell_list_filter_source', ['woocommerce','amazon','miravia','decathlon'], null, ['class' => 'form-control select2', 'style' => 'width:100%', 'placeholder' => __('lang_v1.all')]); !!}
        </div>
    </div> --}}
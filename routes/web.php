...
use App\Http\Controllers\Miravia\MiraviaController;
use App\Http\Controllers\Decathlon\DecathlonController;
use App\Http\Controllers\Amazon\AmazonController;
use App\Http\Controllers\ArtisanController;
use App\Http\Controllers\ComponentController;
use App\Http\Controllers\GenerateLabelsController;
use App\Http\Controllers\Miravia\MiraviaApiController;
...
Route::get('/run-generate-fedex-labels-command', function () {
    try {
...
Route::get('/run-generate-gls-labels-command', function () {
    try {
...
Route::get('/sync-woo-orders-all', function () {
    try {
        Artisan::call('pos:WoocommerceSyncOrder');
        return 'command run successfully.';
    } catch (\Exception $e) {
        return 'Failed to run command: ' . $e->getMessage();
    }
...
Route::middleware(['setData', 'auth', 'SetSessionData', 'language', 'timezone', 'AdminSidebarMenu', 'CheckUserLogin'])->group(function () {
    ...
    Route::get('/reports/sell-report', [ReportController::class, 'getPurchaseSell']);
    Route::get('/reports/customer-report', [ReportController::class, 'getCustomerSuppliers']);
    ...
    Route::post('/run-generate-shipping-command', [GenerateLabelsController::class, 'index'])->name('run.generateshipping.command');
    //Route::post('/run-generate-shipping-command', [ArtisanController::class, 'runGenerateShippingCommand'])->name('run.generateshipping.command');
    //Route::post('/run-generate-shipping-command-gls', [ArtisanController::class, 'runGenerateShippingCommandGLS'])->name('run.generateshippinggls.command');
    //Miravia Routes
});

Route::middleware('web', 'SetSessionData', 'auth', 'language', 'timezone', 'AdminSidebarMenu')->prefix('miravia')->group(function () {
    Route::get('/', [MiraviaController::class, 'index'])->name('miravia.home');
    Route::get('/api-settings', [MiraviaController::class, 'apiSettings']);
    Route::post('/update-api-settings', [MiraviaController::class, 'updateSettings']);
    Route::get('/sync-categories', [MiraviaController::class, 'syncCategories']);
    Route::get('/sync-products', [MiraviaController::class, 'syncProducts']);
    Route::get('/sync-log', [MiraviaController::class, 'getSyncLog']);
    Route::get('/getProductType', [MiraviaController::class, 'getProductType'])->name('miravia.getProductType');
    Route::get('/getProductSkus', [MiraviaController::class, 'getProductSkus'])->name('miravia.getProductSkus');
    Route::get('/sync-orders', [MiraviaController::class, 'syncOrders']);
    Route::post('/map-taxrates', [MiraviaController::class, 'mapTaxRates']);
    Route::get('/view-sync-log', [MiraviaController::class, 'viewSyncLog']);
    Route::get('/get-log-details/{id}', [MiraviaController::class, 'getLogDetails']);
    Route::get('/reset-categories', [MiraviaController::class, 'resetCategories']);
    Route::get('/reset-products', [MiraviaController::class, 'resetProducts']);
    
    Route::get('/products', [MiraviaController::class, 'getProducts'])->name('miravia.products');
    Route::get('/orders', [MiraviaController::class, 'getOrders'])->name('miravia.orders');
    Route::get('/stock', [MiraviaController::class, 'syncStock'])->name('miravia.stock');
});

Route::middleware('web', 'SetSessionData', 'auth', 'language', 'timezone', 'AdminSidebarMenu')->prefix('decathlon')->group(function () {
    Route::get('/', [DecathlonController::class, 'index']);
    Route::get('/api-settings', [DecathlonController::class, 'apiSettings']);
    Route::post('/update-api-settings', [DecathlonController::class, 'updateSettings']);
    Route::get('/sync-categories', [DecathlonController::class, 'syncCategories']);
    Route::get('/sync-products', [DecathlonController::class, 'syncProducts']);
    Route::get('/sync-log', [DecathlonController::class, 'getSyncLog']);
    Route::get('/sync-orders', [DecathlonController::class, 'syncOrders']);
    Route::post('/map-taxrates', [DecathlonController::class, 'mapTaxRates']);
    Route::get('/view-sync-log', [DecathlonController::class, 'viewSyncLog']);
    Route::get('/get-log-details/{id}', [DecathlonController::class, 'getLogDetails']);
    Route::get('/reset-categories', [DecathlonController::class, 'resetCategories']);
    Route::get('/reset-products', [DecathlonController::class, 'resetProducts']);
});

Route::middleware('web', 'SetSessionData', 'auth', 'language', 'timezone', 'AdminSidebarMenu')->prefix('amazon')->group(function () {
    Route::get('/', [AmazonController::class, 'index']);
    Route::get('/api-settings', [AmazonController::class, 'apiSettings']);
    Route::post('/update-api-settings', [AmazonController::class, 'updateSettings']);
    Route::get('/sync-categories', [AmazonController::class, 'syncCategories']);
    Route::get('/sync-products', [AmazonController::class, 'syncProducts']);
    Route::get('/sync-stocks', [AmazonController::class, 'syncStocks']);
    Route::get('/sync-log', [AmazonController::class, 'getSyncLog']);
    Route::get('/sync-orders', [AmazonController::class, 'syncOrders'])->name('amazon.syncorders');
    Route::post('/map-taxrates', [AmazonController::class, 'mapTaxRates']);
    Route::get('/view-sync-log', [AmazonController::class, 'viewSyncLog']);
    Route::get('/get-log-details/{id}', [AmazonController::class, 'getLogDetails']);
    Route::get('/reset-categories', [AmazonController::class, 'resetCategories']);
    Route::get('/reset-products', [AmazonController::class, 'resetProducts']);
});
...
Route::middleware('web', 'SetSessionData', 'auth', 'language', 'timezone', 'AdminSidebarMenu')->prefix('decathlon')->group(function () {
    ...
    Route::get('/sync-categories', [DecathlonController::class, 'syncCategories']);
    Route::get('/sync-products', [DecathlonController::class, 'syncProducts']);
    Route::get('/sync-stocks', [DecathlonController::class, 'syncStocks']);
    Route::get('/sync-log', [DecathlonController::class, 'getSyncLog']);
    Route::get('/sync-orders', [DecathlonController::class, 'syncOrders'])->name('decathlon.syncorders');
    Route::post('/map-taxrates', [DecathlonController::class, 'mapTaxRates']);
    Route::get('/view-sync-log', [DecathlonController::class, 'viewSyncLog']);
    Route::get('/get-log-details/{id}', [DecathlonController::class, 'getLogDetails']);
    Route::get('/reset-categories', [DecathlonController::class, 'resetCategories']);
...
Route::middleware(['setData', 'auth', 'SetSessionData', 'language', 'timezone'])->group(function () {
    ...
    Route::get('/sells/{transaction_id}/printgls', [SellPosController::class, 'printInvoiceGls'])->name('sell.printInvoiceGls');


    Route::get('/download-sells/{transaction_id}/pdf', [SellPosController::class, 'downloadPdf'])->name('sell.downloadPdf');

    Route::post('/download-bulk-invoices', 
    [SellPosController::class, 'downloadBulkInvoicesPdf'])->name('sell.downloadBulkInvoicesPdf');
